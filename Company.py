...
class Company():
    ...
    # save company description to txt file
    def save_company_description_to(self,filename = "_company_description"):

        # open new file in write mode
        file = open(self.name+filename+".txt","w")

        # write description
        file.write(self.print_company_description(False))

        # close the file properly
        file.close()

        # inform the user
        print("{} company description is successfully saved!".format(self.name))

    def save_income_statement(self,filename = "_income_statement"):

        # open new file in write mode
        file = open(self.name+filename+".txt","w")

        # write description
        file.write(self.print_income_statement(False))

        # close the file properly
        file.close()

        # inform the user
        print("{} income statement is successfully saved!".format(self.name))
