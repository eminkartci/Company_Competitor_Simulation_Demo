...
simEnv.save_competitor_income_statements()

competitorsPandasForm = simEnv.get_closest_competitors(competitor1.longitude, competitor1.latitude)

print(type(competitorsPandasForm))